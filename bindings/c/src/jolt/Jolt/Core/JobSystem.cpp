...
JPH_JobSystem_JobHandle *JPH_JobSystem_CreateJob(JPH_JobSystem *_this, const char *inName, const JPH_Color *inColor, const Jolt_std_function_void *inJobFunction, const unsigned int *inNumDependencies)
{
    using namespace JPH;
    return (JPH_JobSystem_JobHandle *)new JPH::JobSystem::JobHandle(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(JPH::JobSystem *)(_this)).CreateJob(
        inName,
