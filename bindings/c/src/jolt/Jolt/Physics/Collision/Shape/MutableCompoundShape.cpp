...
const Jolt_JPH_Array_JPH_CompoundShapeSettings_SubShapeSettings *JPH_MutableCompoundShapeSettings_Get_mSubShapes(const JPH_MutableCompoundShapeSettings *_this)
{
    return (const Jolt_JPH_Array_JPH_CompoundShapeSettings_SubShapeSettings *)std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::MutableCompoundShapeSettings *)(_this)).mSubShapes);
}

void JPH_MutableCompoundShapeSettings_Set_mSubShapes(JPH_MutableCompoundShapeSettings *_this, Jolt_PassBy value_pass_by, Jolt_JPH_Array_JPH_CompoundShapeSettings_SubShapeSettings *value)
{
    MRBINDC_CLASSARG_GUARD(value, JPH::Array<JPH::CompoundShapeSettings::SubShapeSettings>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(JPH::MutableCompoundShapeSettings *)(_this)).mSubShapes = (MRBINDC_CLASSARG_DEF_CTOR(value, JPH::Array<JPH::CompoundShapeSettings::SubShapeSettings>) MRBINDC_CLASSARG_COPY(value, (JPH::Array<JPH::CompoundShapeSettings::SubShapeSettings>), JPH::Array<JPH::CompoundShapeSettings::SubShapeSettings>) MRBINDC_CLASSARG_MOVE(value, (JPH::Array<JPH::CompoundShapeSettings::SubShapeSettings>), JPH::Array<JPH::CompoundShapeSettings::SubShapeSettings>) MRBINDC_CLASSARG_NO_DEF_ARG(value, Jolt_PassBy_DefaultArgument, JPH::Array<JPH::CompoundShapeSettings::SubShapeSettings>) MRBINDC_CLASSARG_NO_DEF_ARG(value, Jolt_PassBy_NoObject, JPH::Array<JPH::CompoundShapeSettings::SubShapeSettings>) MRBINDC_CLASSARG_END(value, JPH::Array<JPH::CompoundShapeSettings::SubShapeSettings>));
}

Jolt_JPH_Array_JPH_CompoundShapeSettings_SubShapeSettings *JPH_MutableCompoundShapeSettings_GetMutable_mSubShapes(JPH_MutableCompoundShapeSettings *_this)
{
    return (Jolt_JPH_Array_JPH_CompoundShapeSettings_SubShapeSettings *)std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(JPH::MutableCompoundShapeSettings *)(_this)).mSubShapes);
}
...
void *Jolt_new_JPH_MutableCompoundShapeSettings_size_t(size_t inCount)
{
...
void Jolt_delete_JPH_MutableCompoundShapeSettings_void_ptr_size_t(void *inPointer, size_t inSize)
{
    JPH::MutableCompoundShapeSettings::operator delete(
        inPointer,
        inSize
...
void *Jolt_new_array_JPH_MutableCompoundShapeSettings_size_t(size_t inCount)
{
    return JPH::MutableCompoundShapeSettings::operator new[](
        inCount
    );
...
void Jolt_delete_array_JPH_MutableCompoundShapeSettings_void_ptr_size_t(void *inPointer, size_t inSize)
{
    JPH::MutableCompoundShapeSettings::operator delete[](
        inPointer,
        inSize
...
void *Jolt_new_JPH_MutableCompoundShapeSettings_size_t_void_ptr(size_t inCount, void *inPointer)
{
    return JPH::MutableCompoundShapeSettings::operator new(
        inCount,
        inPointer
...
void *Jolt_new_array_JPH_MutableCompoundShapeSettings_size_t_void_ptr(size_t inCount, void *inPointer)
{
    return JPH::MutableCompoundShapeSettings::operator new[](
        inCount,
        inPointer
...
void *Jolt_new_JPH_MutableCompoundShape_size_t(size_t inCount)
{
...
void Jolt_delete_JPH_MutableCompoundShape_void_ptr_size_t(void *inPointer, size_t inSize)
{
    JPH::MutableCompoundShape::operator delete(
        inPointer,
        inSize
...
void *Jolt_new_array_JPH_MutableCompoundShape_size_t(size_t inCount)
{
    return JPH::MutableCompoundShape::operator new[](
        inCount
    );
...
void Jolt_delete_array_JPH_MutableCompoundShape_void_ptr_size_t(void *inPointer, size_t inSize)
{
    JPH::MutableCompoundShape::operator delete[](
        inPointer,
        inSize
...
void *Jolt_new_JPH_MutableCompoundShape_size_t_void_ptr(size_t inCount, void *inPointer)
{
    return JPH::MutableCompoundShape::operator new(
        inCount,
        inPointer
...
void *Jolt_new_array_JPH_MutableCompoundShape_size_t_void_ptr(size_t inCount, void *inPointer)
{
    return JPH::MutableCompoundShape::operator new[](
        inCount,
        inPointer
...
bool JPH_MutableCompoundShape_CastRay_3(const JPH_MutableCompoundShape *_this, const JPH_RayCast *inRay, const JPH_SubShapeIDCreator *inSubShapeIDCreator, JPH_RayCastResult *ioHit)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::MutableCompoundShape *)(_this)).CastRay(
...
JPH_TransformedShape *JPH_MutableCompoundShape_GetSubShapeTransformedShape(const JPH_MutableCompoundShape *_this, const JPH_SubShapeID *inSubShapeID, const JPH_Vec3 *inPositionCOM, const JPH_Quat *inRotation, const JPH_Vec3 *inScale, JPH_SubShapeID *outRemainder)
{
    return (JPH_TransformedShape *)new JPH::TransformedShape(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::MutableCompoundShape *)(_this)).GetSubShapeTransformedShape(
        ((inSubShapeID ? void() : MRBINDC_THROW("Parameter `inSubShapeID` can not be null.", void)), *(const JPH::SubShapeID *)(inSubShapeID)),
...
const Jolt_JPH_Array_JPH_CompoundShape_SubShape *JPH_MutableCompoundShape_GetSubShapes(const JPH_MutableCompoundShape *_this)
{
    return (const Jolt_JPH_Array_JPH_CompoundShape_SubShape *)std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::MutableCompoundShape *)(_this)).GetSubShapes());
}
...
JPH_SubShapeIDCreator *JPH_MutableCompoundShape_GetSubShapeIDFromIndex(const JPH_MutableCompoundShape *_this, int inIdx, const JPH_SubShapeIDCreator *inParentSubShapeID)
{
    return (JPH_SubShapeIDCreator *)new JPH::SubShapeIDCreator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::MutableCompoundShape *)(_this)).GetSubShapeIDFromIndex(
        inIdx,
