...
void *Jolt_new_JPH_DecoratedShapeSettings_size_t(size_t inCount)
{
...
void Jolt_delete_JPH_DecoratedShapeSettings_void_ptr_size_t(void *inPointer, size_t inSize)
{
    JPH::DecoratedShapeSettings::operator delete(
        inPointer,
        inSize
...
void *Jolt_new_array_JPH_DecoratedShapeSettings_size_t(size_t inCount)
{
    return JPH::DecoratedShapeSettings::operator new[](
        inCount
    );
...
void Jolt_delete_array_JPH_DecoratedShapeSettings_void_ptr_size_t(void *inPointer, size_t inSize)
{
    JPH::DecoratedShapeSettings::operator delete[](
        inPointer,
        inSize
...
void *Jolt_new_JPH_DecoratedShapeSettings_size_t_void_ptr(size_t inCount, void *inPointer)
{
    return JPH::DecoratedShapeSettings::operator new(
        inCount,
        inPointer
...
void *Jolt_new_array_JPH_DecoratedShapeSettings_size_t_void_ptr(size_t inCount, void *inPointer)
{
    return JPH::DecoratedShapeSettings::operator new[](
        inCount,
        inPointer
...
const bool *JPH_DecoratedShape_Get_sDrawSubmergedVolumes(void)
{
    return std::addressof(JPH::DecoratedShape::sDrawSubmergedVolumes);
}

void JPH_DecoratedShape_Set_sDrawSubmergedVolumes(bool value)
{
    JPH::DecoratedShape::sDrawSubmergedVolumes = value;
}

bool *JPH_DecoratedShape_GetMutable_sDrawSubmergedVolumes(void)
{
    return std::addressof(JPH::DecoratedShape::sDrawSubmergedVolumes);
}
...
void *Jolt_new_JPH_DecoratedShape_size_t(size_t inCount)
{
...
void Jolt_delete_JPH_DecoratedShape_void_ptr_size_t(void *inPointer, size_t inSize)
{
    JPH::DecoratedShape::operator delete(
        inPointer,
        inSize
...
void *Jolt_new_array_JPH_DecoratedShape_size_t(size_t inCount)
{
    return JPH::DecoratedShape::operator new[](
        inCount
    );
...
void Jolt_delete_array_JPH_DecoratedShape_void_ptr_size_t(void *inPointer, size_t inSize)
{
    JPH::DecoratedShape::operator delete[](
        inPointer,
        inSize
...
void *Jolt_new_JPH_DecoratedShape_size_t_void_ptr(size_t inCount, void *inPointer)
{
    return JPH::DecoratedShape::operator new(
        inCount,
        inPointer
...
void *Jolt_new_array_JPH_DecoratedShape_size_t_void_ptr(size_t inCount, void *inPointer)
{
    return JPH::DecoratedShape::operator new[](
        inCount,
        inPointer
...
JPH_TransformedShape *JPH_DecoratedShape_GetSubShapeTransformedShape(const JPH_DecoratedShape *_this, const JPH_SubShapeID *inSubShapeID, const JPH_Vec3 *inPositionCOM, const JPH_Quat *inRotation, const JPH_Vec3 *inScale, JPH_SubShapeID *outRemainder)
{
    return (JPH_TransformedShape *)new JPH::TransformedShape(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::DecoratedShape *)(_this)).GetSubShapeTransformedShape(
        ((inSubShapeID ? void() : MRBINDC_THROW("Parameter `inSubShapeID` can not be null.", void)), *(const JPH::SubShapeID *)(inSubShapeID)),
...
void JPH_DecoratedShape_GetSubmergedVolume(const JPH_DecoratedShape *_this, const JPH_Mat44 *inCenterOfMassTransform, const JPH_Vec3 *inScale, const JPH_Plane *inSurface, float *outTotalVolume, float *outSubmergedVolume, JPH_Vec3 *outCenterOfBuoyancy, const JPH_Vec3 *inBaseOffset)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::DecoratedShape *)(_this)).GetSubmergedVolume(
...
void JPH_DecoratedShape_Draw(const JPH_DecoratedShape *_this, JPH_DebugRenderer *inRenderer, const JPH_Mat44 *inCenterOfMassTransform, const JPH_Vec3 *inScale, const JPH_Color *inColor, bool inUseMaterialColors, bool inDrawWireframe)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::DecoratedShape *)(_this)).Draw(
...
void JPH_DecoratedShape_DrawGetSupportFunction(const JPH_DecoratedShape *_this, JPH_DebugRenderer *inRenderer, const JPH_Mat44 *inCenterOfMassTransform, const JPH_Vec3 *inScale, const JPH_Color *inColor, bool inDrawSupportDirection)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::DecoratedShape *)(_this)).DrawGetSupportFunction(
        ((JPH::DebugRenderer *)inRenderer),
        ((inCenterOfMassTransform ? void() : MRBINDC_THROW("Parameter `inCenterOfMassTransform` can not be null.", void)), *(const JPH::Mat44 *)(inCenterOfMassTransform)),
        ((inScale ? void() : MRBINDC_THROW("Parameter `inScale` can not be null.", void)), JPH::Vec3(*(JPH::Vec3 *)inScale)),
        ((inColor ? void() : MRBINDC_THROW("Parameter `inColor` can not be null.", void)), JPH::Color(*(JPH::Color *)inColor)),
...
void JPH_DecoratedShape_DrawGetSupportingFace(const JPH_DecoratedShape *_this, JPH_DebugRenderer *inRenderer, const JPH_Mat44 *inCenterOfMassTransform, const JPH_Vec3 *inScale)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::DecoratedShape *)(_this)).DrawGetSupportingFace(
        ((JPH::DebugRenderer *)inRenderer),
        ((inCenterOfMassTransform ? void() : MRBINDC_THROW("Parameter `inCenterOfMassTransform` can not be null.", void)), *(const JPH::Mat44 *)(inCenterOfMassTransform)),
        ((inScale ? void() : MRBINDC_THROW("Parameter `inScale` can not be null.", void)), JPH::Vec3(*(JPH::Vec3 *)inScale))
    );
