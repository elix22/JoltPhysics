...
const bool *JPH_HeightFieldShape_Get_sDrawTriangleOutlines(void)
{
    return std::addressof(JPH::HeightFieldShape::sDrawTriangleOutlines);
}

void JPH_HeightFieldShape_Set_sDrawTriangleOutlines(bool value)
{
    JPH::HeightFieldShape::sDrawTriangleOutlines = value;
}

bool *JPH_HeightFieldShape_GetMutable_sDrawTriangleOutlines(void)
{
    return std::addressof(JPH::HeightFieldShape::sDrawTriangleOutlines);
}
...
const bool *JPH_HeightFieldShape_Get_sDrawSubmergedVolumes(void)
{
    return std::addressof(JPH::HeightFieldShape::sDrawSubmergedVolumes);
}

void JPH_HeightFieldShape_Set_sDrawSubmergedVolumes(bool value)
{
    JPH::HeightFieldShape::sDrawSubmergedVolumes = value;
}

bool *JPH_HeightFieldShape_GetMutable_sDrawSubmergedVolumes(void)
{
    return std::addressof(JPH::HeightFieldShape::sDrawSubmergedVolumes);
}
...
void JPH_HeightFieldShape_GetSubmergedVolume(const JPH_HeightFieldShape *_this, const JPH_Mat44 *inCenterOfMassTransform, const JPH_Vec3 *inScale, const JPH_Plane *inSurface, float *outTotalVolume, float *outSubmergedVolume, JPH_Vec3 *outCenterOfBuoyancy, const JPH_Vec3 *inBaseOffset)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::HeightFieldShape *)(_this)).GetSubmergedVolume(
...
void JPH_HeightFieldShape_Draw(const JPH_HeightFieldShape *_this, JPH_DebugRenderer *inRenderer, const JPH_Mat44 *inCenterOfMassTransform, const JPH_Vec3 *inScale, const JPH_Color *inColor, bool inUseMaterialColors, bool inDrawWireframe)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::HeightFieldShape *)(_this)).Draw(
...
bool JPH_HeightFieldShape_CastRay_3(const JPH_HeightFieldShape *_this, const JPH_RayCast *inRay, const JPH_SubShapeIDCreator *inSubShapeIDCreator, JPH_RayCastResult *ioHit)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::HeightFieldShape *)(_this)).CastRay(
...
JPH_TransformedShape *JPH_HeightFieldShape_GetSubShapeTransformedShape(const JPH_HeightFieldShape *_this, const JPH_SubShapeID *inSubShapeID, const JPH_Vec3 *inPositionCOM, const JPH_Quat *inRotation, const JPH_Vec3 *inScale, JPH_SubShapeID *outRemainder)
{
    return (JPH_TransformedShape *)new JPH::TransformedShape(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::HeightFieldShape *)(_this)).GetSubShapeTransformedShape(
        ((inSubShapeID ? void() : MRBINDC_THROW("Parameter `inSubShapeID` can not be null.", void)), *(const JPH::SubShapeID *)(inSubShapeID)),
        ((inPositionCOM ? void() : MRBINDC_THROW("Parameter `inPositionCOM` can not be null.", void)), JPH::Vec3(*(JPH::Vec3 *)inPositionCOM)),
        ((inRotation ? void() : MRBINDC_THROW("Parameter `inRotation` can not be null.", void)), JPH::Quat(*(JPH::Quat *)inRotation)),
        ((inScale ? void() : MRBINDC_THROW("Parameter `inScale` can not be null.", void)), JPH::Vec3(*(JPH::Vec3 *)inScale)),
...
void JPH_HeightFieldShape_DrawGetSupportFunction(const JPH_HeightFieldShape *_this, JPH_DebugRenderer *inRenderer, const JPH_Mat44 *inCenterOfMassTransform, const JPH_Vec3 *inScale, const JPH_Color *inColor, bool inDrawSupportDirection)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::HeightFieldShape *)(_this)).DrawGetSupportFunction(
        ((JPH::DebugRenderer *)inRenderer),
        ((inCenterOfMassTransform ? void() : MRBINDC_THROW("Parameter `inCenterOfMassTransform` can not be null.", void)), *(const JPH::Mat44 *)(inCenterOfMassTransform)),
        ((inScale ? void() : MRBINDC_THROW("Parameter `inScale` can not be null.", void)), JPH::Vec3(*(JPH::Vec3 *)inScale)),
        ((inColor ? void() : MRBINDC_THROW("Parameter `inColor` can not be null.", void)), JPH::Color(*(JPH::Color *)inColor)),
...
void JPH_HeightFieldShape_DrawGetSupportingFace(const JPH_HeightFieldShape *_this, JPH_DebugRenderer *inRenderer, const JPH_Mat44 *inCenterOfMassTransform, const JPH_Vec3 *inScale)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const JPH::HeightFieldShape *)(_this)).DrawGetSupportingFace(
        ((JPH::DebugRenderer *)inRenderer),
        ((inCenterOfMassTransform ? void() : MRBINDC_THROW("Parameter `inCenterOfMassTransform` can not be null.", void)), *(const JPH::Mat44 *)(inCenterOfMassTransform)),
        ((inScale ? void() : MRBINDC_THROW("Parameter `inScale` can not be null.", void)), JPH::Vec3(*(JPH::Vec3 *)inScale))
    );
