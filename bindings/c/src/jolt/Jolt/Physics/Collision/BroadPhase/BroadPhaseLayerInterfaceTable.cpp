...
void *Jolt_new_JPH_BroadPhaseLayerInterfaceTable_unsigned_long(unsigned long inCount)
{
...
void Jolt_delete_JPH_BroadPhaseLayerInterfaceTable_void_ptr_unsigned_long(void *inPointer, unsigned long inSize)
{
    JPH::BroadPhaseLayerInterfaceTable::operator delete(
        inPointer,
        inSize
...
void *Jolt_new_array_JPH_BroadPhaseLayerInterfaceTable_unsigned_long(unsigned long inCount)
{
    return JPH::BroadPhaseLayerInterfaceTable::operator new[](
        inCount
    );
...
void Jolt_delete_array_JPH_BroadPhaseLayerInterfaceTable_void_ptr_unsigned_long(void *inPointer, unsigned long inSize)
{
    JPH::BroadPhaseLayerInterfaceTable::operator delete[](
        inPointer,
        inSize
...
void *Jolt_new_JPH_BroadPhaseLayerInterfaceTable_unsigned_long_void_ptr(unsigned long inCount, void *inPointer)
{
    return JPH::BroadPhaseLayerInterfaceTable::operator new(
        inCount,
        inPointer
...
void *Jolt_new_array_JPH_BroadPhaseLayerInterfaceTable_unsigned_long_void_ptr(unsigned long inCount, void *inPointer)
{
    return JPH::BroadPhaseLayerInterfaceTable::operator new[](
        inCount,
        inPointer
