...
typedef struct Jolt_std_function_JPH_Vec3_from_JPH_Vec3 Jolt_std_function_JPH_Vec3_from_JPH_Vec3;

/// Constructs an empty (default-constructed) instance.
/// Never returns null. Returns an instance allocated on the heap! Must call `Jolt_std_function_JPH_Vec3_from_JPH_Vec3_Destroy()` to free it when you're done using it.
JOLT_API Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *Jolt_std_function_JPH_Vec3_from_JPH_Vec3_DefaultConstruct(void);

/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `Jolt_std_function_JPH_Vec3_from_JPH_Vec3_DestroyArray()`.
/// Use `Jolt_std_function_JPH_Vec3_from_JPH_Vec3_OffsetMutablePtr()` and `Jolt_std_function_JPH_Vec3_from_JPH_Vec3_OffsetPtr()` to access the array elements.
JOLT_API Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *Jolt_std_function_JPH_Vec3_from_JPH_Vec3_DefaultConstructArray(size_t num_elems);

/// Constructs a copy of another instance. The source remains alive.
/// The reference to the parameter `other` might be preserved in the constructed object.
/// Never returns null. Returns an instance allocated on the heap! Must call `Jolt_std_function_JPH_Vec3_from_JPH_Vec3_Destroy()` to free it when you're done using it.
/// When this function is called, this object will drop any object references it held previously.
JOLT_API Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *Jolt_std_function_JPH_Vec3_from_JPH_Vec3_ConstructFromAnother(Jolt_PassBy other_pass_by, Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *other);

/// Assigns the contents from another instance. Both objects remain alive after the call.
/// Parameter `_this` can not be null. It is a single object.
/// The reference to the parameter `other` might be preserved in this object.
/// When this function is called, this object will drop any object references it held previously.
JOLT_API void Jolt_std_function_JPH_Vec3_from_JPH_Vec3_AssignFromAnother(Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *_this, Jolt_PassBy other_pass_by, Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *other);

/// Destroys a heap-allocated instance of `Jolt_std_function_JPH_Vec3_from_JPH_Vec3`. Does nothing if the pointer is null.
JOLT_API void Jolt_std_function_JPH_Vec3_from_JPH_Vec3_Destroy(const Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *_this);

/// Destroys a heap-allocated array of `Jolt_std_function_JPH_Vec3_from_JPH_Vec3`. Does nothing if the pointer is null.
JOLT_API void Jolt_std_function_JPH_Vec3_from_JPH_Vec3_DestroyArray(const Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *_this);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
/// The reference to the parameter `ptr` might be preserved in the return value.
JOLT_API const Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *Jolt_std_function_JPH_Vec3_from_JPH_Vec3_OffsetPtr(const Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *ptr, ptrdiff_t i);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
/// The reference to the parameter `ptr` might be preserved in the return value.
JOLT_API Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *Jolt_std_function_JPH_Vec3_from_JPH_Vec3_OffsetMutablePtr(Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *ptr, ptrdiff_t i);

/// Returns true if this instance stores a callable, as opposed to being null.
/// Parameter `_this` can not be null. It is a single object.
JOLT_API bool Jolt_std_function_JPH_Vec3_from_JPH_Vec3_has_value(const Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *_this);

/// Destroys the stored callable, making this instance null.
/// Parameter `_this` can not be null. It is a single object.
JOLT_API void Jolt_std_function_JPH_Vec3_from_JPH_Vec3_reset(Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *_this);

/// Calls the stored callable.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `_1` can not be null. It is a single object.
/// Never returns null. Returns an instance allocated on the heap! Must call `JPH_Vec3_Destroy()` to free it when you're done using it.
JOLT_API JPH_Vec3 *Jolt_std_function_JPH_Vec3_from_JPH_Vec3_call(const Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *_this, const JPH_Vec3 *_1);
...
JOLT_API Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *Jolt_std_function_JPH_Vec3_from_JPH_Vec3_ConstructStateless(const JPH_Vec3 *(*func)(JPH_Vec3 *_1));
...
/// In C++ that parameter is an rvalue reference.
/// Callback return value can not be null.
JOLT_API void Jolt_std_function_JPH_Vec3_from_JPH_Vec3_Assign(Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *_this, const JPH_Vec3 *(*func)(JPH_Vec3 *_1));
...
JOLT_API Jolt_std_function_JPH_Vec3_from_JPH_Vec3 *Jolt_std_function_JPH_Vec3_from_JPH_Vec3_ConstructEx(const JPH_Vec3 *(*func)(JPH_Vec3 *_1, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
