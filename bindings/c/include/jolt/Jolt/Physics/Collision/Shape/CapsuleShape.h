...
JOLT_API void *Jolt_new_JPH_CapsuleShapeSettings_size_t(size_t inCount);
...
/// Generated from method `JPH::CapsuleShapeSettings::operator delete`.
JOLT_API void Jolt_delete_JPH_CapsuleShapeSettings_void_ptr_size_t(void *inPointer, size_t inSize);

/// Generated from method `JPH::CapsuleShapeSettings::operator new[]`.
JOLT_API void *Jolt_new_array_JPH_CapsuleShapeSettings_size_t(size_t inCount);

/// Generated from method `JPH::CapsuleShapeSettings::operator delete[]`.
JOLT_API void Jolt_delete_array_JPH_CapsuleShapeSettings_void_ptr(void *inPointer);

/// Generated from method `JPH::CapsuleShapeSettings::operator delete[]`.
JOLT_API void Jolt_delete_array_JPH_CapsuleShapeSettings_void_ptr_size_t(void *inPointer, size_t inSize);

/// Generated from method `JPH::CapsuleShapeSettings::operator new`.
JOLT_API void *Jolt_new_JPH_CapsuleShapeSettings_size_t_void_ptr(size_t inCount, void *inPointer);

/// Generated from method `JPH::CapsuleShapeSettings::operator delete`.
JOLT_API void Jolt_delete_JPH_CapsuleShapeSettings_void_ptr_void_ptr(void *inPointer, void *inPlace);

/// Generated from method `JPH::CapsuleShapeSettings::operator new[]`.
JOLT_API void *Jolt_new_array_JPH_CapsuleShapeSettings_size_t_void_ptr(size_t inCount, void *inPointer);
...
JOLT_API void *Jolt_new_JPH_CapsuleShape_size_t(size_t inCount);

/// Generated from method `JPH::CapsuleShape::operator delete`.
JOLT_API void Jolt_delete_JPH_CapsuleShape_void_ptr(void *inPointer);

/// Generated from method `JPH::CapsuleShape::operator delete`.
JOLT_API void Jolt_delete_JPH_CapsuleShape_void_ptr_size_t(void *inPointer, size_t inSize);

/// Generated from method `JPH::CapsuleShape::operator new[]`.
JOLT_API void *Jolt_new_array_JPH_CapsuleShape_size_t(size_t inCount);

/// Generated from method `JPH::CapsuleShape::operator delete[]`.
JOLT_API void Jolt_delete_array_JPH_CapsuleShape_void_ptr(void *inPointer);

/// Generated from method `JPH::CapsuleShape::operator delete[]`.
JOLT_API void Jolt_delete_array_JPH_CapsuleShape_void_ptr_size_t(void *inPointer, size_t inSize);

/// Generated from method `JPH::CapsuleShape::operator new`.
JOLT_API void *Jolt_new_JPH_CapsuleShape_size_t_void_ptr(size_t inCount, void *inPointer);

/// Generated from method `JPH::CapsuleShape::operator delete`.
JOLT_API void Jolt_delete_JPH_CapsuleShape_void_ptr_void_ptr(void *inPointer, void *inPlace);

/// Generated from method `JPH::CapsuleShape::operator new[]`.
JOLT_API void *Jolt_new_array_JPH_CapsuleShape_size_t_void_ptr(size_t inCount, void *inPointer);
...
JOLT_API bool JPH_CapsuleShape_CastRay_3(const JPH_CapsuleShape *_this, const JPH_RayCast *inRay, const JPH_SubShapeIDCreator *inSubShapeIDCreator, JPH_RayCastResult *ioHit);
...
JOLT_API JPH_TransformedShape *JPH_CapsuleShape_GetSubShapeTransformedShape(const JPH_CapsuleShape *_this, const JPH_SubShapeID *inSubShapeID, const JPH_Vec3 *inPositionCOM, const JPH_Quat *inRotation, const JPH_Vec3 *inScale, JPH_SubShapeID *outRemainder);
