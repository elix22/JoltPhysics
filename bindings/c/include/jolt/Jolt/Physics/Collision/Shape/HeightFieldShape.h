...
JOLT_API bool JPH_HeightFieldShape_CastRay_3(const JPH_HeightFieldShape *_this, const JPH_RayCast *inRay, const JPH_SubShapeIDCreator *inSubShapeIDCreator, JPH_RayCastResult *ioHit);
