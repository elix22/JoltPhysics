...
JOLT_API void *Jolt_new_JPH_BroadPhaseLayerInterfaceTable_size_t(size_t inCount);
...
/// Generated from method `JPH::BroadPhaseLayerInterfaceTable::operator delete`.
JOLT_API void Jolt_delete_JPH_BroadPhaseLayerInterfaceTable_void_ptr_size_t(void *inPointer, size_t inSize);

/// Generated from method `JPH::BroadPhaseLayerInterfaceTable::operator new[]`.
JOLT_API void *Jolt_new_array_JPH_BroadPhaseLayerInterfaceTable_size_t(size_t inCount);

/// Generated from method `JPH::BroadPhaseLayerInterfaceTable::operator delete[]`.
JOLT_API void Jolt_delete_array_JPH_BroadPhaseLayerInterfaceTable_void_ptr(void *inPointer);

/// Generated from method `JPH::BroadPhaseLayerInterfaceTable::operator delete[]`.
JOLT_API void Jolt_delete_array_JPH_BroadPhaseLayerInterfaceTable_void_ptr_size_t(void *inPointer, size_t inSize);

/// Generated from method `JPH::BroadPhaseLayerInterfaceTable::operator new`.
JOLT_API void *Jolt_new_JPH_BroadPhaseLayerInterfaceTable_size_t_void_ptr(size_t inCount, void *inPointer);

/// Generated from method `JPH::BroadPhaseLayerInterfaceTable::operator delete`.
JOLT_API void Jolt_delete_JPH_BroadPhaseLayerInterfaceTable_void_ptr_void_ptr(void *inPointer, void *inPlace);

/// Generated from method `JPH::BroadPhaseLayerInterfaceTable::operator new[]`.
JOLT_API void *Jolt_new_array_JPH_BroadPhaseLayerInterfaceTable_size_t_void_ptr(size_t inCount, void *inPointer);
