...
JOLT_API void *Jolt_new_JPH_DistanceConstraintSettings_size_t(size_t inCount);
...
/// Generated from method `JPH::DistanceConstraintSettings::operator delete`.
JOLT_API void Jolt_delete_JPH_DistanceConstraintSettings_void_ptr_size_t(void *inPointer, size_t inSize);

/// Generated from method `JPH::DistanceConstraintSettings::operator new[]`.
JOLT_API void *Jolt_new_array_JPH_DistanceConstraintSettings_size_t(size_t inCount);

/// Generated from method `JPH::DistanceConstraintSettings::operator delete[]`.
JOLT_API void Jolt_delete_array_JPH_DistanceConstraintSettings_void_ptr(void *inPointer);

/// Generated from method `JPH::DistanceConstraintSettings::operator delete[]`.
JOLT_API void Jolt_delete_array_JPH_DistanceConstraintSettings_void_ptr_size_t(void *inPointer, size_t inSize);

/// Generated from method `JPH::DistanceConstraintSettings::operator new`.
JOLT_API void *Jolt_new_JPH_DistanceConstraintSettings_size_t_void_ptr(size_t inCount, void *inPointer);

/// Generated from method `JPH::DistanceConstraintSettings::operator delete`.
JOLT_API void Jolt_delete_JPH_DistanceConstraintSettings_void_ptr_void_ptr(void *inPointer, void *inPlace);

/// Generated from method `JPH::DistanceConstraintSettings::operator new[]`.
JOLT_API void *Jolt_new_array_JPH_DistanceConstraintSettings_size_t_void_ptr(size_t inCount, void *inPointer);
...
JOLT_API void *Jolt_new_JPH_DistanceConstraint_size_t(size_t inCount);
...
/// Generated from method `JPH::DistanceConstraint::operator delete`.
JOLT_API void Jolt_delete_JPH_DistanceConstraint_void_ptr_size_t(void *inPointer, size_t inSize);

/// Generated from method `JPH::DistanceConstraint::operator new[]`.
JOLT_API void *Jolt_new_array_JPH_DistanceConstraint_size_t(size_t inCount);

/// Generated from method `JPH::DistanceConstraint::operator delete[]`.
JOLT_API void Jolt_delete_array_JPH_DistanceConstraint_void_ptr(void *inPointer);

/// Generated from method `JPH::DistanceConstraint::operator delete[]`.
JOLT_API void Jolt_delete_array_JPH_DistanceConstraint_void_ptr_size_t(void *inPointer, size_t inSize);

/// Generated from method `JPH::DistanceConstraint::operator new`.
JOLT_API void *Jolt_new_JPH_DistanceConstraint_size_t_void_ptr(size_t inCount, void *inPointer);

/// Generated from method `JPH::DistanceConstraint::operator delete`.
JOLT_API void Jolt_delete_JPH_DistanceConstraint_void_ptr_void_ptr(void *inPointer, void *inPlace);

/// Generated from method `JPH::DistanceConstraint::operator new[]`.
JOLT_API void *Jolt_new_array_JPH_DistanceConstraint_size_t_void_ptr(size_t inCount, void *inPointer);
...
/// Parameter `_this` can not be null. It is a single object.
JOLT_API void JPH_DistanceConstraint_DrawConstraint(const JPH_DistanceConstraint *_this, JPH_DebugRenderer *inRenderer);
...
/// Parameter `_this` can not be null. It is a single object.
JOLT_API void JPH_DistanceConstraint_DrawConstraintReferenceFrame(const JPH_DistanceConstraint *_this, JPH_DebugRenderer *inRenderer);
...
/// Parameter `_this` can not be null. It is a single object.
JOLT_API void JPH_DistanceConstraint_DrawConstraintLimits(const JPH_DistanceConstraint *_this, JPH_DebugRenderer *inRenderer);

/// Size of constraint when drawing it through the debug renderer
/// Generated from method `JPH::DistanceConstraint::GetDrawConstraintSize`.
/// Parameter `_this` can not be null. It is a single object.
JOLT_API float JPH_DistanceConstraint_GetDrawConstraintSize(const JPH_DistanceConstraint *_this);

/// Generated from method `JPH::DistanceConstraint::SetDrawConstraintSize`.
/// Parameter `_this` can not be null. It is a single object.
JOLT_API void JPH_DistanceConstraint_SetDrawConstraintSize(JPH_DistanceConstraint *_this, float inSize);
