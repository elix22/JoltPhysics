...
typedef struct Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float;

/// Constructs an empty (default-constructed) instance.
/// Never returns null. Returns an instance allocated on the heap! Must call `Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_Destroy()` to free it when you're done using it.
JOLT_API Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float *Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_DefaultConstruct(void);

/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_DestroyArray()`.
/// Use `Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_OffsetMutablePtr()` and `Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_OffsetPtr()` to access the array elements.
JOLT_API Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float *Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_DefaultConstructArray(size_t num_elems);

/// Constructs a copy of another instance. The source remains alive.
/// The reference to the parameter `other` might be preserved in the constructed object.
/// Never returns null. Returns an instance allocated on the heap! Must call `Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_Destroy()` to free it when you're done using it.
/// When this function is called, this object will drop any object references it held previously.
JOLT_API Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float *Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_ConstructFromAnother(Jolt_PassBy other_pass_by, Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float *other);

/// Assigns the contents from another instance. Both objects remain alive after the call.
/// Parameter `_this` can not be null. It is a single object.
/// The reference to the parameter `other` might be preserved in this object.
/// When this function is called, this object will drop any object references it held previously.
JOLT_API void Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_AssignFromAnother(Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float *_this, Jolt_PassBy other_pass_by, Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float *other);

/// Destroys a heap-allocated instance of `Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float`. Does nothing if the pointer is null.
JOLT_API void Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_Destroy(const Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float *_this);

/// Destroys a heap-allocated array of `Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float`. Does nothing if the pointer is null.
JOLT_API void Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_DestroyArray(const Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float *_this);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
/// The reference to the parameter `ptr` might be preserved in the return value.
JOLT_API const Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float *Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_OffsetPtr(const Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float *ptr, ptrdiff_t i);
...
/// Parameter `_this` can not be null. It is a single object.
JOLT_API bool Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_has_value(const Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float *_this);

/// Destroys the stored callable, making this instance null.
/// Parameter `_this` can not be null. It is a single object.
JOLT_API void Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_reset(Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float *_this);
...
JOLT_API void Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_call(const Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float *_this, unsigned int _1, float *_2, float *_3, float _4, float _5, float _6, float _7, float _8, float _9);
...
/// Callback parameter `_2` will never be null. It is non-owning, do NOT destroy it.
/// Callback parameter `_3` will never be null. It is non-owning, do NOT destroy it.
JOLT_API void Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_Assign(Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float *_this, void (*func)(unsigned int _1, float *_2, float *_3, float _4, float _5, float _6, float _7, float _8, float _9));
...
///   If `*_this_userdata` is non-null and `_other_userdata` is non-null, the functor is being assigned. The simplest option is to destroy `*_this_userdata` first, and then behave as if it was null.
///   Both `*_this_userdata` and `_other_userdata` will never be null at the same time.
JOLT_API void Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float_AssignEx(Jolt_std_function_void_from_unsigned_int_float_ref_float_ref_float_float_float_float_float_float *_this, void (*func)(unsigned int _1, float *_2, float *_3, float _4, float _5, float _6, float _7, float _8, float _9, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
