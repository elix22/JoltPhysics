...
typedef struct Jolt_std_function_void_from_int Jolt_std_function_void_from_int;

/// Constructs an empty (default-constructed) instance.
/// Never returns null. Returns an instance allocated on the heap! Must call `Jolt_std_function_void_from_int_Destroy()` to free it when you're done using it.
JOLT_API Jolt_std_function_void_from_int *Jolt_std_function_void_from_int_DefaultConstruct(void);

/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `Jolt_std_function_void_from_int_DestroyArray()`.
/// Use `Jolt_std_function_void_from_int_OffsetMutablePtr()` and `Jolt_std_function_void_from_int_OffsetPtr()` to access the array elements.
JOLT_API Jolt_std_function_void_from_int *Jolt_std_function_void_from_int_DefaultConstructArray(size_t num_elems);

/// Constructs a copy of another instance. The source remains alive.
/// The reference to the parameter `other` might be preserved in the constructed object.
/// Never returns null. Returns an instance allocated on the heap! Must call `Jolt_std_function_void_from_int_Destroy()` to free it when you're done using it.
/// When this function is called, this object will drop any object references it held previously.
JOLT_API Jolt_std_function_void_from_int *Jolt_std_function_void_from_int_ConstructFromAnother(Jolt_PassBy other_pass_by, Jolt_std_function_void_from_int *other);

/// Assigns the contents from another instance. Both objects remain alive after the call.
/// Parameter `_this` can not be null. It is a single object.
/// The reference to the parameter `other` might be preserved in this object.
/// When this function is called, this object will drop any object references it held previously.
JOLT_API void Jolt_std_function_void_from_int_AssignFromAnother(Jolt_std_function_void_from_int *_this, Jolt_PassBy other_pass_by, Jolt_std_function_void_from_int *other);

/// Destroys a heap-allocated instance of `Jolt_std_function_void_from_int`. Does nothing if the pointer is null.
JOLT_API void Jolt_std_function_void_from_int_Destroy(const Jolt_std_function_void_from_int *_this);

/// Destroys a heap-allocated array of `Jolt_std_function_void_from_int`. Does nothing if the pointer is null.
JOLT_API void Jolt_std_function_void_from_int_DestroyArray(const Jolt_std_function_void_from_int *_this);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
/// The reference to the parameter `ptr` might be preserved in the return value.
JOLT_API const Jolt_std_function_void_from_int *Jolt_std_function_void_from_int_OffsetPtr(const Jolt_std_function_void_from_int *ptr, ptrdiff_t i);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
/// The reference to the parameter `ptr` might be preserved in the return value.
JOLT_API Jolt_std_function_void_from_int *Jolt_std_function_void_from_int_OffsetMutablePtr(Jolt_std_function_void_from_int *ptr, ptrdiff_t i);

/// Returns true if this instance stores a callable, as opposed to being null.
/// Parameter `_this` can not be null. It is a single object.
JOLT_API bool Jolt_std_function_void_from_int_has_value(const Jolt_std_function_void_from_int *_this);

/// Destroys the stored callable, making this instance null.
/// Parameter `_this` can not be null. It is a single object.
JOLT_API void Jolt_std_function_void_from_int_reset(Jolt_std_function_void_from_int *_this);

/// Calls the stored callable.
/// Parameter `_this` can not be null. It is a single object.
JOLT_API void Jolt_std_function_void_from_int_call(const Jolt_std_function_void_from_int *_this, int _1);

/// Construct a stateless function.
/// Never returns null. Returns an instance allocated on the heap! Must call `Jolt_std_function_void_from_int_Destroy()` to free it when you're done using it.
JOLT_API Jolt_std_function_void_from_int *Jolt_std_function_void_from_int_ConstructStateless(void (*func)(int _1));

/// Assign a stateless function.
/// Parameter `_this` can not be null. It is a single object.
JOLT_API void Jolt_std_function_void_from_int_Assign(Jolt_std_function_void_from_int *_this, void (*func)(int _1));
...
JOLT_API Jolt_std_function_void_from_int *Jolt_std_function_void_from_int_ConstructEx(void (*func)(int _1, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
...
///   If `*_this_userdata` is non-null and `_other_userdata` is non-null, the functor is being assigned. The simplest option is to destroy `*_this_userdata` first, and then behave as if it was null.
///   Both `*_this_userdata` and `_other_userdata` will never be null at the same time.
JOLT_API void Jolt_std_function_void_from_int_AssignEx(Jolt_std_function_void_from_int *_this, void (*func)(int _1, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
