...
public static partial class JPH
{
    ...
    public class Const_Factory : JPH.Object<Const_Factory>, System.IDisposable
    {
        ...
        public static unsafe JPH.Factory? SInstance
        {
            get
            {
                #if __IOS__
                ...
                #endif
                extern static JPH.Factory._Underlying **__JPH_Factory_Get_sInstance();
                var ptr = __JPH_Factory_Get_sInstance();
                JPH.Factory? value = null;
                if (*ptr is not null)
        ...
        public unsafe Const_Factory() : this(null, is_owning: true)
        {
            ...
            #endif
            extern static JPH.Factory._Underlying *__JPH_Factory_DefaultConstruct();
            _UnderlyingPtr = __JPH_Factory_DefaultConstruct();
        }

        /// Generated from constructor `JPH::Factory::Factory`.
        public unsafe Const_Factory(JPH._ByValue_Factory _other) : this(null, is_owning: true)
        {
            #if __IOS__
            ...
            #endif
            extern static JPH.Factory._Underlying *__JPH_Factory_ConstructFromAnother(JPH._PassBy _other_pass_by, JPH.Factory._Underlying *_other);
        ...
        {
            #if __IOS__
            [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "Jolt_new_JPH_Factory_size_t", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #else
            [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "Jolt_new_JPH_Factory_size_t", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #endif
            extern static void *__Jolt_new_JPH_Factory_size_t(UIntPtr inCount);
            return __Jolt_new_JPH_Factory_size_t(inCount);
        }
        ...
        {
            #if __IOS__
            [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "Jolt_delete_JPH_Factory_void_ptr_size_t", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #else
            [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "Jolt_delete_JPH_Factory_void_ptr_size_t", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #endif
            extern static void __Jolt_delete_JPH_Factory_void_ptr_size_t(void *inPointer, UIntPtr inSize);
            __Jolt_delete_JPH_Factory_void_ptr_size_t(inPointer, inSize);
        }
        ...
        {
            #if __IOS__
            [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "Jolt_new_array_JPH_Factory_size_t", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #else
            [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "Jolt_new_array_JPH_Factory_size_t", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #endif
            extern static void *__Jolt_new_array_JPH_Factory_size_t(UIntPtr inCount);
            return __Jolt_new_array_JPH_Factory_size_t(inCount);
        }
        ...
        {
            #if __IOS__
            [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "Jolt_delete_array_JPH_Factory_void_ptr_size_t", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #else
            [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "Jolt_delete_array_JPH_Factory_void_ptr_size_t", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #endif
            extern static void __Jolt_delete_array_JPH_Factory_void_ptr_size_t(void *inPointer, UIntPtr inSize);
            __Jolt_delete_array_JPH_Factory_void_ptr_size_t(inPointer, inSize);
        }
        ...
        {
            #if __IOS__
            [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "Jolt_new_JPH_Factory_size_t_void_ptr", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #else
            [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "Jolt_new_JPH_Factory_size_t_void_ptr", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #endif
            extern static void *__Jolt_new_JPH_Factory_size_t_void_ptr(UIntPtr inCount, void *inPointer);
            return __Jolt_new_JPH_Factory_size_t_void_ptr(inCount, inPointer);
        }
        ...
        {
            #if __IOS__
            [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "Jolt_new_array_JPH_Factory_size_t_void_ptr", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #else
            [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "Jolt_new_array_JPH_Factory_size_t_void_ptr", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #endif
            extern static void *__Jolt_new_array_JPH_Factory_size_t_void_ptr(UIntPtr inCount, void *inPointer);
            return __Jolt_new_array_JPH_Factory_size_t_void_ptr(inCount, inPointer);
        }
    ...
    public class Factory : Const_Factory
    {
        ...
        /// Generated from constructor `JPH::Factory::Factory`.
        public unsafe Factory(JPH._ByValue_Factory _other) : this(null, is_owning: true)
        {
            #if __IOS__
            [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "JPH_Factory_ConstructFromAnother", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #else
        ...
        public unsafe JPH.Factory Assign(JPH._ByValue_Factory _other)
        {
            #if __IOS__
            ...
            #endif
            extern static JPH.Factory._Underlying *__JPH_Factory_AssignFromAnother(_Underlying *_this, JPH._PassBy _other_pass_by, JPH.Factory._Underlying *_other);
            _DiscardKeepAlive();
            if (_other.Value is not null) _KeepAlive(_other.Value);
    ...
    public class _ByValue_Factory
    {
        ...
        public _ByValue_Factory() {PassByMode = JPH._PassBy.default_construct;}
        public _ByValue_Factory(Const_Factory new_value) {Value = new_value; PassByMode = JPH._PassBy.copy;}
        public static implicit operator _ByValue_Factory(Const_Factory arg) {return new(arg);}
        public _ByValue_Factory(JPH._Moved<Factory> moved) {Value = moved.Value; PassByMode = JPH._PassBy.move;}
        public static implicit operator _ByValue_Factory(JPH._Moved<Factory> arg) {return new(arg);}
    }
