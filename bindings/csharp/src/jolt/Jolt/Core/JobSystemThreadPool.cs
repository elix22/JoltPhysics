...
public static partial class JPH
{
    ...
    public class Const_JobSystemThreadPool : JPH.Object<Const_JobSystemThreadPool>, System.IDisposable
    {
        ...
        public static unsafe explicit operator Const_JobSystemThreadPool?(JPH.Const_JobSystem parent)
        {
            ...
            #endif
            extern static _Underlying *__JPH_JobSystemThreadPool_DynamicDowncastFrom_JPH_JobSystem(JPH.Const_JobSystem._Underlying *_this);
        ...
        public static unsafe explicit operator Const_JobSystemThreadPool?(JPH.Const_JobSystemWithBarrier parent)
        {
            ...
            #endif
            extern static _Underlying *__JPH_JobSystemThreadPool_DynamicDowncastFrom_JPH_JobSystemWithBarrier(JPH.Const_JobSystemWithBarrier._Underlying *_this);
        ...
        public static unsafe void *New(ulong inCount)
        {
            ...
            #endif
            extern static void *__Jolt_new_JPH_JobSystemThreadPool_size_t(ulong inCount);
        ...
        public static unsafe void Delete(void *inPointer, ulong inSize)
        {
            ...
            #endif
            extern static void __Jolt_delete_JPH_JobSystemThreadPool_void_ptr_size_t(void *inPointer, ulong inSize);
        ...
        public static unsafe void *NewArray(ulong inCount)
        {
            ...
            #endif
            extern static void *__Jolt_new_array_JPH_JobSystemThreadPool_size_t(ulong inCount);
        ...
        public static unsafe void DeleteArray(void *inPointer, ulong inSize)
        {
            ...
            #endif
            extern static void __Jolt_delete_array_JPH_JobSystemThreadPool_void_ptr_size_t(void *inPointer, ulong inSize);
        ...
        public static unsafe void *New(ulong inCount, void *inPointer)
        {
            ...
            #endif
            extern static void *__Jolt_new_JPH_JobSystemThreadPool_size_t_void_ptr(ulong inCount, void *inPointer);
        ...
        public static unsafe void *NewArray(ulong inCount, void *inPointer)
        {
            ...
            #endif
            extern static void *__Jolt_new_array_JPH_JobSystemThreadPool_size_t_void_ptr(ulong inCount, void *inPointer);
    ...
    public class JobSystemThreadPool : Const_JobSystemThreadPool
    {
        ...
        public static unsafe explicit operator JobSystemThreadPool?(JPH.JobSystem parent)
        {
            ...
            [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "JPH_JobSystemThreadPool_DynamicDowncastFrom_JPH_JobSystem", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #endif
            extern static _Underlying *__JPH_JobSystemThreadPool_DynamicDowncastFrom_JPH_JobSystem(JPH.JobSystem._Underlying *_this);
            var ptr = __JPH_JobSystemThreadPool_DynamicDowncastFrom_JPH_JobSystem(parent._UnderlyingPtr);
            if (ptr is null) return null;
        ...
        public static unsafe explicit operator JobSystemThreadPool?(JPH.JobSystemWithBarrier parent)
        {
            ...
            [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "JPH_JobSystemThreadPool_DynamicDowncastFrom_JPH_JobSystemWithBarrier", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #endif
            extern static _Underlying *__JPH_JobSystemThreadPool_DynamicDowncastFrom_JPH_JobSystemWithBarrier(JPH.JobSystemWithBarrier._Underlying *_this);
            var ptr = __JPH_JobSystemThreadPool_DynamicDowncastFrom_JPH_JobSystemWithBarrier(parent._UnderlyingPtr);
            if (ptr is null) return null;
            JobSystemThreadPool ret = new(ptr, is_owning: false);
            ret._KeepAliveEnclosingObject = parent;
