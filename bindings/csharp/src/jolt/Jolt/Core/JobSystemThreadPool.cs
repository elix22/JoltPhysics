...
public static partial class JPH
{
    ...
    public class JobSystemThreadPool : Const_JobSystemThreadPool
    {
        ...
        {
            #if __IOS__
            [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "JPH_JobSystemThreadPool_CreateJob", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #else
            [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "JPH_JobSystemThreadPool_CreateJob", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #endif
            extern static JPH.JobSystem.JobHandle._Underlying *__JPH_JobSystemThreadPool_CreateJob(_Underlying *_this, byte *inName, JPH.Color._Underlying *inColor, JPH.Std.Const_Function_Void._Underlying *inJobFunction, uint *inNumDependencies);
            byte __deref_inName = inName.GetValueOrDefault();
            uint __deref_inNumDependencies = inNumDependencies.GetValueOrDefault();
            return new(__JPH_JobSystemThreadPool_CreateJob(_UnderlyingPtr, inName.HasValue ? &__deref_inName : null, inColor._UnderlyingPtr, inJobFunction._UnderlyingPtr, inNumDependencies.HasValue ? &__deref_inNumDependencies : null), is_owning: true);
        }
