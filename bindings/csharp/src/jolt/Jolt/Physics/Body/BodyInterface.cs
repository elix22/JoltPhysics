...
public static partial class JPH
{
    ...
    public class Const_BodyInterface : JPH.Object<Const_BodyInterface>, System.IDisposable
    {
        ...
        // Downcasts:
        public static unsafe explicit operator Const_BodyInterface(JPH.Const_NonCopyable parent)
        {
            #if __IOS__
            [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "JPH_BodyInterface_StaticDowncastFrom_JPH_NonCopyable", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #else
            [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "JPH_BodyInterface_StaticDowncastFrom_JPH_NonCopyable", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #endif
            extern static _Underlying *__JPH_BodyInterface_StaticDowncastFrom_JPH_NonCopyable(JPH.Const_NonCopyable._Underlying *_this);
            Const_BodyInterface ret = new(__JPH_BodyInterface_StaticDowncastFrom_JPH_NonCopyable(parent._UnderlyingPtr), is_owning: false);
    ...
    public class BodyInterface : Const_BodyInterface
    {
        ...
        public static unsafe implicit operator JPH.Const_NonCopyable(BodyInterface self)
            => (JPH.Const_NonCopyable)(JPH.Const_BodyInterface)self;

        // Downcasts:
        public static unsafe explicit operator BodyInterface(JPH.NonCopyable parent)
        {
            #if __IOS__
            [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "JPH_BodyInterface_StaticDowncastFrom_JPH_NonCopyable", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #else
            [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "JPH_BodyInterface_StaticDowncastFrom_JPH_NonCopyable", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #endif
            extern static _Underlying *__JPH_BodyInterface_StaticDowncastFrom_JPH_NonCopyable(JPH.NonCopyable._Underlying *_this);
            BodyInterface ret = new(__JPH_BodyInterface_StaticDowncastFrom_JPH_NonCopyable(parent._UnderlyingPtr), is_owning: false);
            ret._KeepAliveEnclosingObject = parent;
            return ret;
        }
