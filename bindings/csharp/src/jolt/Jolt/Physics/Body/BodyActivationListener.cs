...
public static partial class Jolt
{
    public static partial class JPH
    {
        ...
        public class Const_BodyActivationListener : Jolt.Object<Const_BodyActivationListener>, System.IDisposable
        {
        ...
        public class BodyActivationListener : Const_BodyActivationListener
        {
            ...
            public unsafe void OnBodyActivated(in Jolt.JPH.BodyID inBodyID, ulong inBodyUserData)
            {
                #if __IOS__
                ...
                #endif
                extern static void __JPH_BodyActivationListener_OnBodyActivated(_Underlying *_this, Jolt.JPH.BodyID *inBodyID, ulong inBodyUserData);
            ...
            public unsafe void OnBodyDeactivated(in Jolt.JPH.BodyID inBodyID, ulong inBodyUserData)
            {
                #if __IOS__
                ...
                #endif
                extern static void __JPH_BodyActivationListener_OnBodyDeactivated(_Underlying *_this, Jolt.JPH.BodyID *inBodyID, ulong inBodyUserData);
                fixed (Jolt.JPH.BodyID *__ptr_inBodyID = &inBodyID)
                {
