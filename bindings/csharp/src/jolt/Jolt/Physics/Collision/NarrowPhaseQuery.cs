...
public static partial class Jolt
{
    public static partial class JPH
    {
        ...
        public class Const_NarrowPhaseQuery : Jolt.Object<Const_NarrowPhaseQuery>, System.IDisposable
        {
            ...
            // Upcasts:
            public static unsafe implicit operator Jolt.JPH.Const_NonCopyable(Const_NarrowPhaseQuery self)
            {
                #if __IOS__
                ...
                #endif
                extern static Jolt.JPH.Const_NonCopyable._Underlying *__JPH_NarrowPhaseQuery_UpcastTo_JPH_NonCopyable(_Underlying *_this);
                Jolt.JPH.Const_NonCopyable ret = new(__JPH_NarrowPhaseQuery_UpcastTo_JPH_NonCopyable(self._UnderlyingPtr), is_owning: false);
            ...
            public unsafe Const_NarrowPhaseQuery() : this(null, is_owning: true)
            {
                ...
                #endif
                extern static Jolt.JPH.NarrowPhaseQuery._Underlying *__JPH_NarrowPhaseQuery_DefaultConstruct();
        ...
        {
            // Upcasts:
            public static unsafe implicit operator Jolt.JPH.NonCopyable(NarrowPhaseQuery self)
            {
                #if __IOS__
                [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "JPH_NarrowPhaseQuery_UpcastTo_JPH_NonCopyable", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
                #else
                [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "JPH_NarrowPhaseQuery_UpcastTo_JPH_NonCopyable", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
                #endif
                extern static Jolt.JPH.NonCopyable._Underlying *__JPH_NarrowPhaseQuery_UpcastTo_JPH_NonCopyable(_Underlying *_this);
                Jolt.JPH.NonCopyable ret = new(__JPH_NarrowPhaseQuery_UpcastTo_JPH_NonCopyable(self._UnderlyingPtr), is_owning: false);
                ret._KeepAliveEnclosingObject = self;
                return ret;
            }
        ...
        public class _ByValue_NarrowPhaseQuery
        {
            ...
            public _ByValue_NarrowPhaseQuery() {PassByMode = Jolt._PassBy.default_construct;}
        }
