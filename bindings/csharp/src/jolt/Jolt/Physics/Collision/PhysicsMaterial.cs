...
public static partial class JPH
{
    ...
    public class Const_PhysicsMaterial : JPH.Object<Const_PhysicsMaterial>, System.IDisposable
    {
        ...
        protected virtual unsafe void Dispose(bool disposing)
        {
            ...
            #endif
            extern static void *__JPH_PhysicsMaterial_UpcastTo_JPH_RefTarget_JPH_PhysicsMaterial(_Underlying *_this);
            #if __IOS__
            ...
            __JPH_RefTarget_JPH_PhysicsMaterial_Release(__JPH_PhysicsMaterial_UpcastTo_JPH_RefTarget_JPH_PhysicsMaterial(_UnderlyingPtr));
            _UnderlyingPtr = null;
        }
        ...
        public unsafe Const_PhysicsMaterial() : this(null, is_owning: true)
        {
            ...
            __JPH_RefTarget_JPH_PhysicsMaterial_AddRef(__JPH_PhysicsMaterial_UpcastTo_JPH_RefTarget_JPH_PhysicsMaterial(_UnderlyingPtr));
        }
    ...
    public class PhysicsMaterial : Const_PhysicsMaterial
    {
        ...
        public static unsafe implicit operator JPH.Const_SerializableObject(PhysicsMaterial self)
            => (JPH.Const_SerializableObject)(JPH.Const_PhysicsMaterial)self;
        ...
        public static unsafe implicit operator JPH.Const_RefTarget_JPHPhysicsMaterial(PhysicsMaterial self)
            => (JPH.Const_RefTarget_JPHPhysicsMaterial)(JPH.Const_PhysicsMaterial)self;
