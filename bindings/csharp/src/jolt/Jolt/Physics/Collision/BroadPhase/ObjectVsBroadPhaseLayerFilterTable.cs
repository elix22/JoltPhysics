...
public static partial class Jolt
{
    public static partial class JPH
    {
        ...
        public class Const_ObjectVsBroadPhaseLayerFilterTable : Jolt.Object<Const_ObjectVsBroadPhaseLayerFilterTable>, System.IDisposable
        {
            ...
            // Upcasts:
            public static unsafe implicit operator Jolt.JPH.Const_NonCopyable(Const_ObjectVsBroadPhaseLayerFilterTable self)
            {
                #if __IOS__
                ...
                #endif
                extern static Jolt.JPH.Const_NonCopyable._Underlying *__JPH_ObjectVsBroadPhaseLayerFilterTable_UpcastTo_JPH_NonCopyable(_Underlying *_this);
                Jolt.JPH.Const_NonCopyable ret = new(__JPH_ObjectVsBroadPhaseLayerFilterTable_UpcastTo_JPH_NonCopyable(self._UnderlyingPtr), is_owning: false);
                ret._KeepAliveEnclosingObject = self;
                return ret;
            }
            public static unsafe implicit operator Jolt.JPH.Const_ObjectVsBroadPhaseLayerFilter(Const_ObjectVsBroadPhaseLayerFilterTable self)
            {
                #if __IOS__
                ...
                #endif
                extern static Jolt.JPH.Const_ObjectVsBroadPhaseLayerFilter._Underlying *__JPH_ObjectVsBroadPhaseLayerFilterTable_UpcastTo_JPH_ObjectVsBroadPhaseLayerFilter(_Underlying *_this);
                Jolt.JPH.Const_ObjectVsBroadPhaseLayerFilter ret = new(__JPH_ObjectVsBroadPhaseLayerFilterTable_UpcastTo_JPH_ObjectVsBroadPhaseLayerFilter(self._UnderlyingPtr), is_owning: false);
                ret._KeepAliveEnclosingObject = self;
                return ret;
            }

            // Downcasts:
            public static unsafe explicit operator Const_ObjectVsBroadPhaseLayerFilterTable?(Jolt.JPH.Const_ObjectVsBroadPhaseLayerFilter parent)
            {
                #if __IOS__
                [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "JPH_ObjectVsBroadPhaseLayerFilterTable_DynamicDowncastFrom_JPH_ObjectVsBroadPhaseLayerFilter", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
                #else
                [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "JPH_ObjectVsBroadPhaseLayerFilterTable_DynamicDowncastFrom_JPH_ObjectVsBroadPhaseLayerFilter", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
                #endif
                extern static _Underlying *__JPH_ObjectVsBroadPhaseLayerFilterTable_DynamicDowncastFrom_JPH_ObjectVsBroadPhaseLayerFilter(Jolt.JPH.Const_ObjectVsBroadPhaseLayerFilter._Underlying *_this);
                var ptr = __JPH_ObjectVsBroadPhaseLayerFilterTable_DynamicDowncastFrom_JPH_ObjectVsBroadPhaseLayerFilter(parent._UnderlyingPtr);
                if (ptr is null) return null;
                Const_ObjectVsBroadPhaseLayerFilterTable ret = new(ptr, is_owning: false);
            ...
            public unsafe Const_ObjectVsBroadPhaseLayerFilterTable(Jolt.JPH.Const_BroadPhaseLayerInterface inBroadPhaseLayerInterface, uint inNumBroadPhaseLayers, Jolt.JPH.Const_ObjectLayerPairFilter inObjectLayerPairFilter, uint inNumObjectLayers) : this(null, is_owning: true)
            {
                #if __IOS__
                ...
                #endif
                extern static Jolt.JPH.ObjectVsBroadPhaseLayerFilterTable._Underlying *__JPH_ObjectVsBroadPhaseLayerFilterTable_Construct(Jolt.JPH.Const_BroadPhaseLayerInterface._Underlying *inBroadPhaseLayerInterface, uint inNumBroadPhaseLayers, Jolt.JPH.Const_ObjectLayerPairFilter._Underlying *inObjectLayerPairFilter, uint inNumObjectLayers);
            ...
            public unsafe bool ShouldCollide(ushort inLayer1, Jolt.JPH.Const_BroadPhaseLayer inLayer2)
            {
                ...
                #endif
                extern static byte __JPH_ObjectVsBroadPhaseLayerFilterTable_ShouldCollide(_Underlying *_this, ushort inLayer1, Jolt.JPH.BroadPhaseLayer._Underlying *inLayer2);
        ...
        {
            // Upcasts:
            public static unsafe implicit operator Jolt.JPH.NonCopyable(ObjectVsBroadPhaseLayerFilterTable self)
            {
                #if __IOS__
                [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "JPH_ObjectVsBroadPhaseLayerFilterTable_UpcastTo_JPH_NonCopyable", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
                #else
                [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "JPH_ObjectVsBroadPhaseLayerFilterTable_UpcastTo_JPH_NonCopyable", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
                #endif
                extern static Jolt.JPH.NonCopyable._Underlying *__JPH_ObjectVsBroadPhaseLayerFilterTable_UpcastTo_JPH_NonCopyable(_Underlying *_this);
                Jolt.JPH.NonCopyable ret = new(__JPH_ObjectVsBroadPhaseLayerFilterTable_UpcastTo_JPH_NonCopyable(self._UnderlyingPtr), is_owning: false);
                ret._KeepAliveEnclosingObject = self;
                return ret;
            }
            public static unsafe implicit operator Jolt.JPH.ObjectVsBroadPhaseLayerFilter(ObjectVsBroadPhaseLayerFilterTable self)
            {
                #if __IOS__
                [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "JPH_ObjectVsBroadPhaseLayerFilterTable_UpcastTo_JPH_ObjectVsBroadPhaseLayerFilter", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
                #else
                [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "JPH_ObjectVsBroadPhaseLayerFilterTable_UpcastTo_JPH_ObjectVsBroadPhaseLayerFilter", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
                #endif
                extern static Jolt.JPH.ObjectVsBroadPhaseLayerFilter._Underlying *__JPH_ObjectVsBroadPhaseLayerFilterTable_UpcastTo_JPH_ObjectVsBroadPhaseLayerFilter(_Underlying *_this);
                Jolt.JPH.ObjectVsBroadPhaseLayerFilter ret = new(__JPH_ObjectVsBroadPhaseLayerFilterTable_UpcastTo_JPH_ObjectVsBroadPhaseLayerFilter(self._UnderlyingPtr), is_owning: false);
                ret._KeepAliveEnclosingObject = self;
                return ret;
            }

            // Downcasts:
            public static unsafe explicit operator ObjectVsBroadPhaseLayerFilterTable?(Jolt.JPH.ObjectVsBroadPhaseLayerFilter parent)
            {
                #if __IOS__
                [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "JPH_ObjectVsBroadPhaseLayerFilterTable_DynamicDowncastFrom_JPH_ObjectVsBroadPhaseLayerFilter", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
                #else
                [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "JPH_ObjectVsBroadPhaseLayerFilterTable_DynamicDowncastFrom_JPH_ObjectVsBroadPhaseLayerFilter", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
                #endif
                extern static _Underlying *__JPH_ObjectVsBroadPhaseLayerFilterTable_DynamicDowncastFrom_JPH_ObjectVsBroadPhaseLayerFilter(Jolt.JPH.ObjectVsBroadPhaseLayerFilter._Underlying *_this);
                var ptr = __JPH_ObjectVsBroadPhaseLayerFilterTable_DynamicDowncastFrom_JPH_ObjectVsBroadPhaseLayerFilter(parent._UnderlyingPtr);
                if (ptr is null) return null;
                ObjectVsBroadPhaseLayerFilterTable ret = new(ptr, is_owning: false);
                ret._KeepAliveEnclosingObject = parent;
                return ret;
            }
            ...
            /// @param inNumObjectLayers Number of object layers
            /// Generated from constructor `JPH::ObjectVsBroadPhaseLayerFilterTable::ObjectVsBroadPhaseLayerFilterTable`.
            public unsafe ObjectVsBroadPhaseLayerFilterTable(Jolt.JPH.Const_BroadPhaseLayerInterface inBroadPhaseLayerInterface, uint inNumBroadPhaseLayers, Jolt.JPH.Const_ObjectLayerPairFilter inObjectLayerPairFilter, uint inNumObjectLayers) : this(null, is_owning: true)
            {
                #if __IOS__
                [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "JPH_ObjectVsBroadPhaseLayerFilterTable_Construct", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
                #else
