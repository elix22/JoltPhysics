...
public static partial class JPH
{
    ...
    public class Const_PathConstraintPathHermite : JPH.Object<Const_PathConstraintPathHermite>, System.IDisposable
    {
        ...
        {
            #if __IOS__
            [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "JPH_PathConstraintPathHermite_DrawPath", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #else
            [System.Runtime.InteropServices.DllImport("cjolt", EntryPoint = "JPH_PathConstraintPathHermite_DrawPath", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
            #endif
            extern static void __JPH_PathConstraintPathHermite_DrawPath(_Underlying *_this, JPH.DebugRenderer._Underlying *inRenderer, JPH.Const_Mat44._Underlying *inBaseTransform);
            __JPH_PathConstraintPathHermite_DrawPath(_UnderlyingPtr, inRenderer is not null ? inRenderer._UnderlyingPtr : null, inBaseTransform._UnderlyingPtr);
        }
