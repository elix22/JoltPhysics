...
public static partial class Jolt
{
    public static partial class JPH
    {
        ...
        public class Const_Float2 : Jolt.Object<Const_Float2>, System.IDisposable, System.IEquatable<Jolt.JPH.Const_Float2>
        {
            ...
            public unsafe Const_Float2() : this(null, is_owning: true)
            {
                ...
                #endif
                extern static Jolt.JPH.Float2._Underlying *__JPH_Float2_DefaultConstruct();
                _UnderlyingPtr = __JPH_Float2_DefaultConstruct();
            }

            /// Generated from constructor `JPH::Float2::Float2`.
            public unsafe Const_Float2(Jolt.JPH.Const_Float2 inRHS) : this(null, is_owning: true)
            {
                #if __IOS__
                ...
                #endif
                extern static Jolt.JPH.Float2._Underlying *__JPH_Float2_ConstructFromAnother(Jolt.JPH.Float2._Underlying *inRHS);
            ...
            public unsafe Const_Float2(float inX, float inY) : this(null, is_owning: true)
            {
                ...
                #endif
                extern static Jolt.JPH.Float2._Underlying *__JPH_Float2_Construct(float inX, float inY);
            ...
            public static unsafe void *New(ulong inCount)
            {
                ...
                #endif
                extern static void *__Jolt_new_JPH_Float2_size_t(ulong inCount);
            ...
            public static unsafe void Delete(void *inPointer, ulong inSize)
            {
                ...
                #endif
                extern static void __Jolt_delete_JPH_Float2_void_ptr_size_t(void *inPointer, ulong inSize);
            ...
            public static unsafe void *NewArray(ulong inCount)
            {
                ...
                #endif
                extern static void *__Jolt_new_array_JPH_Float2_size_t(ulong inCount);
            ...
            public static unsafe void DeleteArray(void *inPointer, ulong inSize)
            {
                ...
                #endif
                extern static void __Jolt_delete_array_JPH_Float2_void_ptr_size_t(void *inPointer, ulong inSize);
            ...
            public static unsafe void *New(ulong inCount, void *inPointer)
            {
                ...
                #endif
                extern static void *__Jolt_new_JPH_Float2_size_t_void_ptr(ulong inCount, void *inPointer);
            ...
            public static unsafe void *NewArray(ulong inCount, void *inPointer)
            {
                ...
                #endif
                extern static void *__Jolt_new_array_JPH_Float2_size_t_void_ptr(ulong inCount, void *inPointer);
            ...
            public static unsafe bool operator==(Jolt.JPH.Const_Float2 _this, Jolt.JPH.Const_Float2 inRHS)
            {
                #if __IOS__
                ...
                #endif
                extern static byte __Jolt_equal_JPH_Float2(Jolt.JPH.Const_Float2._Underlying *_this, Jolt.JPH.Const_Float2._Underlying *inRHS);
            ...
            public bool Equals(Jolt.JPH.Const_Float2? inRHS)
            {
                if (inRHS is null)
                    return false;
                return this == inRHS;
            ...
            public override bool Equals(object? other)
            {
                if (other is null)
                    return false;
                if (other is Jolt.JPH.Const_Float2)
                    return this == (Jolt.JPH.Const_Float2)other;
                return false;
            }
        }
        ...
        public class Float2 : Const_Float2
        {
            ...
            /// Generated from constructor `JPH::Float2::Float2`.
            public unsafe Float2(Jolt.JPH.Const_Float2 inRHS) : this(null, is_owning: true)
            {
                #if __IOS__
                [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "JPH_Float2_ConstructFromAnother", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
                #else
            ...
            /// Generated from method `JPH::Float2::operator=`.
            public unsafe Jolt.JPH.Float2 Assign(Jolt.JPH.Const_Float2 inRHS)
            {
                #if __IOS__
                ...
                #endif
                extern static Jolt.JPH.Float2._Underlying *__JPH_Float2_AssignFromAnother(_Underlying *_this, Jolt.JPH.Float2._Underlying *inRHS);
                Jolt.JPH.Float2 __ret;
