...
public static partial class Jolt
{
    public static partial class JPH
    {
        ...
        public class Const_Float4 : Jolt.Object<Const_Float4>, System.IDisposable, System.IEquatable<Jolt.JPH.Const_Float4>
        {
            ...
            public unsafe Const_Float4() : this(null, is_owning: true)
            {
                ...
                #endif
                extern static Jolt.JPH.Float4._Underlying *__JPH_Float4_DefaultConstruct();
                _UnderlyingPtr = __JPH_Float4_DefaultConstruct();
            }

            /// Generated from constructor `JPH::Float4::Float4`.
            public unsafe Const_Float4(Jolt.JPH.Const_Float4 inRHS) : this(null, is_owning: true)
            {
                #if __IOS__
                ...
                #endif
                extern static Jolt.JPH.Float4._Underlying *__JPH_Float4_ConstructFromAnother(Jolt.JPH.Float4._Underlying *inRHS);
            ...
            public unsafe Const_Float4(float inX, float inY, float inZ, float inW) : this(null, is_owning: true)
            {
                ...
                #endif
                extern static Jolt.JPH.Float4._Underlying *__JPH_Float4_Construct(float inX, float inY, float inZ, float inW);
            ...
            public static unsafe void *New(ulong inCount)
            {
                ...
                #endif
                extern static void *__Jolt_new_JPH_Float4_size_t(ulong inCount);
            ...
            public static unsafe void Delete(void *inPointer, ulong inSize)
            {
                ...
                #endif
                extern static void __Jolt_delete_JPH_Float4_void_ptr_size_t(void *inPointer, ulong inSize);
            ...
            public static unsafe void *NewArray(ulong inCount)
            {
                ...
                #endif
                extern static void *__Jolt_new_array_JPH_Float4_size_t(ulong inCount);
            ...
            public static unsafe void DeleteArray(void *inPointer, ulong inSize)
            {
                ...
                #endif
                extern static void __Jolt_delete_array_JPH_Float4_void_ptr_size_t(void *inPointer, ulong inSize);
            ...
            public static unsafe void *New(ulong inCount, void *inPointer)
            {
                ...
                #endif
                extern static void *__Jolt_new_JPH_Float4_size_t_void_ptr(ulong inCount, void *inPointer);
            ...
            public static unsafe void *NewArray(ulong inCount, void *inPointer)
            {
                ...
                #endif
                extern static void *__Jolt_new_array_JPH_Float4_size_t_void_ptr(ulong inCount, void *inPointer);
            ...
            /// Generated from method `JPH::Float4::operator==`.
            public static unsafe bool operator==(Jolt.JPH.Const_Float4 _this, Jolt.JPH.Const_Float4 inRHS)
            {
                #if __IOS__
                ...
                #endif
                extern static byte __Jolt_equal_JPH_Float4(Jolt.JPH.Const_Float4._Underlying *_this, Jolt.JPH.Const_Float4._Underlying *inRHS);
            ...
            public bool Equals(Jolt.JPH.Const_Float4? inRHS)
            {
                if (inRHS is null)
                    return false;
                return this == inRHS;
            ...
            public override bool Equals(object? other)
            {
                if (other is null)
                    return false;
                if (other is Jolt.JPH.Const_Float4)
                    return this == (Jolt.JPH.Const_Float4)other;
                return false;
            }
        }
        ...
        public class Float4 : Const_Float4
        {
            ...
            /// Generated from constructor `JPH::Float4::Float4`.
            public unsafe Float4(Jolt.JPH.Const_Float4 inRHS) : this(null, is_owning: true)
            {
                #if __IOS__
                [System.Runtime.InteropServices.DllImport("@rpath/cjolt.framework/cjolt", EntryPoint = "JPH_Float4_ConstructFromAnother", CallingConvention = System.Runtime.InteropServices.CallingConvention.Cdecl, ExactSpelling = true)]
                #else
            ...
            /// Generated from method `JPH::Float4::operator=`.
            public unsafe Jolt.JPH.Float4 Assign(Jolt.JPH.Const_Float4 inRHS)
            {
                #if __IOS__
                ...
                #endif
                extern static Jolt.JPH.Float4._Underlying *__JPH_Float4_AssignFromAnother(_Underlying *_this, Jolt.JPH.Float4._Underlying *inRHS);
                Jolt.JPH.Float4 __ret;
